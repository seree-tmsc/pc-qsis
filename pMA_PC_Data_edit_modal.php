                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">                        
                        <div class="col-lg-5">
                            ...
                            <input type="text" id="editShortText" class='form-control' disabled>
                            <input type="hidden" id="parameditShortText" name ='shorttext' class='form-control'>
                            <!--<textarea name="short_text" cols="50" rows="4" required></textarea>-->
                        </div>                        
                        <div class="col-lg-2">
                            <label style="display: block; text-align: right;">Unit Price:</label>
                            <input type="number" id="editUprice" name ='uprice' class='form-control' required style='text-align: right;' step=".01">
                        </div>
                        <div class="col-lg-2">
                            <label style="display: block; text-align: right;">Quantity:</label>
                            <input type="number" id="editQty" name ='qty' class='form-control' required style='text-align: right;'>
                        </div>
                        <div class="col-lg-3">
                            <label style="display: block; text-align: right;">Amount:</label>
                            <input type="number" id="editAmt" class='form-control' disabled style='color: red; text-align: right;'>
                        </div>                        
                    </div>
                    ...
                    <div class="form-group">                        
                        <div class="col-lg-5">
                            ...
                            <input type="text" id="editSupName" class='form-control' disabled>
                            <input type="hidden" id="parameditSupName" name ='supname' class='form-control'>
                        </div>
                    </div>                    
                </div>
