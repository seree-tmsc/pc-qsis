...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $('.edit_data').click(function(){
            ...
            $.ajax({
                ...
                {   
                    ...
                    $('#parameditShortText').val(data['Short Text']);
                    $('#editSupName').val(data['Supplier_Name']);
                    $('#parameditSupName').val(data['Supplier_Name']);
        ...
        $("#editQty").keyup(function()
        {               
            //alert('Key up !');            
            price = parseFloat($('#editUprice').val());
            quantity = parseFloat($('#editQty').val());            
            var amt = price * quantity;
            console.log(price);
            console.log(quantity);
            console.log(amt);            
